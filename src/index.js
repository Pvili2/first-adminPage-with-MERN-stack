...
import DeleteData, { loader as DeleteDataLoader, action as DeleteDataAction } from "./Pages/DeleteData";
...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path="/" element={<IndexLayout />}>
      ...
      <Route path="/deleteItems" element={<DeleteData />} loader={DeleteDataLoader} action={DeleteDataAction} />
    </Route>
  )
);
